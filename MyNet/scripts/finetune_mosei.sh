...
nohup python ./run.py with data_root='/home/mz/demo/TVLT/Dataset/cmumosei/' \
  ...
  gpus=2 tokenizer='/home/mz/demo/MyNet/bert' log_dir='/home/mz/demo/MyNet/tensorboardlog' \
  load_local_path='/home/mz/demo/MyNet/TVLT-MOSEI-SA.ckpt'  > 0226shareparameter.log 2>&1 &

watch 'tail -n5 0226shareparameter.log'


nvidia-smi

# 清理历史训练记录
cd /home/mz/demo/MyNet/sacred_runs && ls -rt | head -n -15 | xargs rm -rf
du -sh /home/mz/demo/MyNet/sacred_runs
